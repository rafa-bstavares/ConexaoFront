...
*/
    ...
    return(
        <div className={`min-h-screen ${atendente? "" : "bg-fundoChat bg-cover"} lg:h-screen flex ${atendente? "lg:flex-row flex-col" : "flex-col"} justify-center items-center  lg:items-stretch relative ${atendente ? "py-4" : "py-[var(--paddingYGeral)]"}`}>
          {
            atendente &&
          ...
          <div className={` ${atendente? "lg:w-1/2 w-full lg:mr-10 h-4/5 self-start mt-8" : "lg:w-2/3 w-full mx-10 h-4/5 self-center"} flex flex-col items-center lg:items-stretch lg:flex-row `}>
